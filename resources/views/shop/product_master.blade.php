...
@section('head')
    ...
    <link rel="stylesheet" href="{{ asset('css/productCard.css') }}?{{ $v }}">
    <link rel="stylesheet" href="{{ asset('css/productCard-0.css') }}?{{ $v }}">
    <link rel="stylesheet" href="{{ asset('css/productCard_adaptation.css') }}?{{ $v }}">
    ...
    <div class="container">
        <div class="main__body">
            ...
            <nav class="breadcrumbs"  itemscope itemtype="http://schema.org/BreadcrumbList">
                ...
                <span itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem">
                    <a itemprop="item" href="{{ route("category_$lang", ['category' => $category->slag]) }}">
                        {{ $category_name }}
                    </a>
...
@section('scripts')
    <script src="{{ asset('js/productCard.js') }}?{{ $v }}" defer></script>
@stop
