                ...
                <x-dropdown align="left" width="48">
                    ...
                    <x-slot name="content" >
                        <div class="sub-menu">
                            ...
                            <x-nav-link :href="route('webhook.log')" >
                                Webhook log
                            </x-nav-link>
                            ...
                            <x-nav-link :href="route('artisan_migrate')" >
                                Migrate
                            </x-nav-link>

                            <x-nav-link :href="route('artisan_migrate', ['command' => 'rollback'])" >
                                Migrate rollback
                            </x-nav-link>
